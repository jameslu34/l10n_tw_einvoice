...
class ResCompany(models.Model):
    ...
    tw_turnkey_host = fields.Char(string="主機位址")
    ...
    tw_turnkey_routing_id = fields.Char(string="傳送方代號")
    tw_turnkey_party_id = fields.Char(string="發票開立人代號")
    
    tw_turnkey_path_xml = fields.Char(string="XML 生成暫存路徑", default="/tmp")
    tw_turnkey_path_input = fields.Char(string="Turnkey 監控路徑", default="/opt/turnkey/UpCast/B2SSTORAGE")
