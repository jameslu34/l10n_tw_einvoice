...
class EinvoiceTrack(models.Model):
    ...
    year = fields.Char(string='民國年 (如 113)', size=3, required=True)
    period = fields.Selection([
        ('01-02', '01-02月'), ('03-04', '03-04月'), ('05-06', '05-06月'),
        ('07-08', '07-08月'), ('09-10', '09-10月'), ('11-12', '11-12月')
    ], string='期別', required=True)
    track_code = fields.Char(string='字軌 (如 AB)', size=2, required=True)
    ...
    current_no = fields.Integer(string='目前使用號碼', required=True, default=0)
